    ...
    //echo "   I am here testing ";
         if($rs->num_rows > 0){ 
            ...
            //  echo "   No premium services ".$msisdn;
               ...
               }   // blacklist and keyword stop.            
               
               if ((is_poll_shortcode($conn, $shorti)) && (!is_int($_REQUEST['text']))){
     ...
     if ($shorti == '31012'){
         // echo " 31012  ";
        $exp_date = "2017-11-18 18:00:00";
   
           $local_company = get_company_from_keyword($conn, $_REQUEST['text']);
           $slogan ="";           
           $numvotes=0;
           if ($local_company=="Ultimate FM"){
                    $category_code = remove_numbers($_REQUEST['text']);
                    $exp_date="";
                     if (strtoupper($category_code) != "SOY"){
                         $exp_date = "2017-11-18 18:00:00";
                     }else{
                         $exp_date = "2017-11-18 21:00:00";
                     }
