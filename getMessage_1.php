...
//$shorti = '';
  ...
  $fields = array( 'msisdn'=>$_REQUEST['msisdn'], 'shortcode'=>$_REQUEST['shortcode'],
      'text'=>$_REQUEST['text'], network-id=>$_REQUEST['network-id'], 'datetime'=>$_REQUEST['time']);
  $postvars = '';
  ...
  $url = "http://154.66.109.36/iec/check.php";
 ...
 // print "test response is:" . $response;
  curl_close ($ch);
   ...
   // $exp_date1 = "2016-11-20 00:00:00";
           ...
           if ($local_company=="Ultimate FM"){
           ...
           else if ($local_company=="Twin Productions"){
                $exp_date = "2017-11-30 17:00:00";
               $numvotes = 20;
               $slogan = " Butha-Buthe Excellence Awards 2017.";
           }
           
           else/* if ($local_company=="LASA")*/{
               $exp_date = "2017-11-30 17:00:00";
               $numvotes = 15;
               $slogan = " in the Alliance Sports Media Awards 2017";
           }
            $todays_date = date("Y-m-d H:i:s");
               ...
               $expiration_date = strtotime($exp_date);
                ...
                //    echo "Ultimate keyword ".$_REQUEST['text'];
                ...
                else if (is_LASA_keyword ($conn, $keyword)){
                   ...
                   if (($expiration_date > $today ) ){
                             $valid = "yes";
                               ...
                               $message = "Thank you for voting ".$new_name.".".$message1." in the Lesotho Annual Sports Awards";
