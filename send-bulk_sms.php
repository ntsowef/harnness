...
else 
{
	...
	{ 
		...
		$query = "SELECT * FROM bulkmessages WHERE queued='Q' LIMIT 100000";
				...
				$row = $rs->fetch_assoc();
                               //  $sender ="+26654000013";
                                ...
                                if ($res->num_rows >0){
                                    ...
                                    $network_sender = "Vodacom_New_BULK_ALPHANUMERIC";
;
                                }else{ 
                                       $sender ="+26652000013";    // this is a correct sender numbers                                   
                                       $network_sender = "Vodacom_New_BULK";
                                }
				...
				$post_data.= '      <dlr-url>http://localhost/sms/dlr_sms.php?type=%d&id='.$row['id'].'</dlr-url>';
				$post_data.= '    </statusrequest>';
				$post_data.= '    <from>';
